...
{
  ASSERT_EQ(zero, intersection(cxt, {SDD('a', values_type(), one)}));
}
...
{
  {
    sdd::dd::intersection_builder<conf, values_type> ops;
  ...
  }
  {
    ...
    values_type val2 {2};
    values_type ref {2};
    sdd::dd::intersection_builder<conf, values_type> ops {val0, val1, val2};
