#ifndef _SDD_ORDER_STRATEGIES_FORCE2_HH_
#define _SDD_ORDER_STRATEGIES_FORCE2_HH_
...
template <typename C>
order<C>
force_ordering2( std::vector<force::vertex<typename C::Identifier>>&& vertices
...
#endif // _SDD_ORDER_STRATEGIES_FORCE2_HH_
